...
class ExperienceCrudController extends AbstractCrudController implements EventSubscriberInterface
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('institution', 'Institution')->setColumns('col-md-6')->hideOnIndex(),
            DateField::new('startDate', 'Date de début')->setColumns('col-md-6'),
            DateField::new('endDate', 'Date de fin')->setColumns('col-md-6'),
        ];
    }
